...
public class User extends AuditingFields{
    ...
    protected User(){}
    private User(Boolean deleted, String username, String password, String code, String name, String nick, String phone, Integer birthyear, String gender, String region, Integer rfrom, String fcm){
    ...
    public static User of(String username, String password, String code, String name, String nick, String phone, Integer birthyear, String gender, String region, Integer rfrom){
        return new User(false, username, password, code, name, nick, phone, birthyear, gender, region, rfrom, null);
    }
