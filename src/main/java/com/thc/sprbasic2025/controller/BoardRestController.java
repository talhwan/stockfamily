...
public class BoardRestController {
    ...
    @PostMapping("")
    public ResponseEntity<DefaultDto.CreateResDto> create(@RequestPart BoardDto.CreateReqDto params, @RequestPart(required = false) MultipartFile file, @AuthenticationPrincipal PrincipalDetails principalDetails){
